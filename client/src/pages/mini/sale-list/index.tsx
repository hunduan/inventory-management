...
const STATUS_STYLE: Record<string, { bg: string; text: string; label: string }> = {
  ...
  SHIPPED: { bg: '#f0f9ff', text: '#075985', label: '已发货' },
      ...
      <ScrollView scrollY style={{ flex: 1, padding: 16 }}>
        {loading ? (
          ...
          <View style={{ backgroundColor: '#ffffff', borderRadius: 16, padding: 48, alignItems: 'center' }}>
            ...
            <Text style={{ fontSize: 14, color: '#a8a29e', marginBottom: 8 }}>暂无销售记录</Text>
            <View
            ...
            return (
              ...
              >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <Text style={{ fontSize: 15, fontWeight: 700, color: '#d97706' }}>¥{Number(o.totalAmount || 0).toFixed(2)}</Text>
                </View>
                {o.warehouse?.name && (
